...
const ChatScreen = (props: Props) => {
    const { selectedUserId, chatId, selectedUserIds, chatName, isGroupChat } =
        props.route.params;
    ...
    const chatData =
        (currentChatId && storedChats[currentChatId]) ||
        props.route?.params ||
        {};
            ...
            >
                                ...
                                <FlatList
                                    ...
                                    renderItem={(itemData) => {
                                        ...
                                        const replyingToUser =
                                            replyToMessage &&
                                            storedUsers[replyToMessage.sentBy];
                ...
                <View style={styles.inputContainer}>
                    ...
                    {editMessage ? (
                        <TouchableOpacity
                            style={styles.mediaButton}
                            onPress={editChatMessageHandler}
                        >
                            <AntDesign
                                name="checkcircle"
                                size={24}
                ...
                <BlurView style={blurOverlayStyle} intensity={22}>
                    <View style={styles.editMessage}>
                        <Bubble
                            ...
                            type="message"
                            subText={formatAmPm(editMessage.sentAt)}
                        />
                    </View>
                </BlurView>
            )}
