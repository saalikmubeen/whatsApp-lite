...
const MessageInfoScreen = (props: Props) => {
    ...
    const { messageText, messageDate, imageUrl, isGroupChat, isSeen, edited } =
        messageDetails;
            ...
            <ImageBackground source={require("../../assets/images/BG.png")}>
                <View>
                    <View style={styles.heading}>
                        <Bubble
                            text={getDayAndDate(messageDate)}
                            type="system"
                        />
                    </View>
                    ...
                    <View style={styles.message}>
                        <MessageInfo
                            text={messageText}
                            dateString={formatAmPm(messageDate)}
                            isSeen={isSeen}
                            edited={edited}
                            imageUrl={imageUrl}
                        />
