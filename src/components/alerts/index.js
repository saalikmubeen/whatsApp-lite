...
import { Text, Animated, View, TouchableOpacity, TouchableWithoutFeedback, ActivityIndicator, BackHandler, Modal, Platform } from "react-native";
...
export default class AwesomeAlert extends Component {
	...
	_renderButton = (data) => {
		const { testID, text, backgroundColor, buttonStyle, buttonTextStyle, onPress } = data;
	...
	_renderAlert = () => {
		...
		const { showCancelButton, cancelText, cancelButtonColor, cancelButtonStyle, cancelButtonTextStyle, onCancelPressed, cancelButtonTestID } =
			this.props;
